...
require (
	codeberg.org/rape4me/kc v0.0.0-20260527075816-a7996790b05b
...
// VKS room transports (internal/vks): mirrors the tamizdat go.mod replace.
// The odin SFU (MTS/Jazz datachannel paths) needs the tweaked DCEP handling.
