...
// whose published video stays above its ceiling for about 40 s, and the
// frame ticker alone does not bound the rate - it bounds how often a sample
// goes out, and a sample carries up to a batch of KCP packets.
