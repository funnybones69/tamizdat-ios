...
import (
	...
	"github.com/funnybones69/tamizdat/vks/olc/core/crypto"
	"github.com/funnybones69/tamizdat/vks/olc/core/logger"
	"github.com/funnybones69/tamizdat/vks/olc/core/muxconn"
	"github.com/funnybones69/tamizdat/vks/olc/core/runtime"
...
type Config struct {
	...
	ChannelID        string
	KeyHex           string
	// ExitOnReconnectExhaustion (tamizdat ladder): when handshake retries
	// are exhausted, cancel the run so the host caller (provider ladder) can
	// advance to the next profile instead of staying a zombie listener.
	ExitOnReconnectExhaustion bool
	LocalAddr                 string
	DNSServer                 string
